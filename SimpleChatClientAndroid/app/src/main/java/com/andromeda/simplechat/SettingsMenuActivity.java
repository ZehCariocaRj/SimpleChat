...
public class SettingsMenuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        logoutButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ApiGateway.setToken(null);
                ApiGateway.setAutomaticLogin(false);
                setResult(1);
                finish();
            }
        });
    ...
    private void saveSettings() {
        ApiGateway.setAutomaticLogin(mAutomaticLogin.isChecked());
        ApiGateway.setStoreLoginInformation(mStoreLoginInformation.isChecked());
    ...
    public class UpdateUserTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            return ApiGateway.updateUser(mDisplayName, mPassword);
        }
